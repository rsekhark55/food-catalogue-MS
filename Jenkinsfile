  ...
  steps {
   ...
   stage('Check code coverage') {
      ...
      steps {
          ...
          sh 'docker build -t rsekhark55/food-catalogue-service:${VERSION} .'
          sh 'docker push rsekhark55/food-catalogue-service:${VERSION}'
      }
    } 
    ...
    stage('Update Image Tag in GitOps') {
      steps {
        ...
        script {
       sh '''
          sed -i "s/image:.*/image: rsekhark55\\/food-catalogue-service:${VERSION}/" aws/food-catalogue-manifest.yml
        '''
